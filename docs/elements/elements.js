...
!function (a, b) {
  ...
  !function (a, b) {
    ...
    function l(a) {
      ...
      var c = F.exec(a);
      if (c) return j(Number(c[1]), { start: y, middle: z, end: A }[c[2]]);
      var d = B[a];
      return d ? d : x
    }
    ...
    function u(a, b, c) {
      ...
      var f = q(c.duration, d, c.iterations, e, c.iterationStart),
        g = r(f, c.iterationStart, d, c.iterations, e, c.duration), h = s(d, c.iterations, g, f),
        i = t(c.direction, h, g);
      return c._easingFunction(i)
    }

    var v = "backwards|forwards|both|none".split("|"), w = "reverse|alternate|alternate-reverse".split("|"),
      x = function (a) {
        return a
      };
    d.prototype = {
    ...
    var h = {
      ...
      j = { thin: "1px", medium: "3px", thick: "5px" }, k = {
        borderBottomWidth: j,
        borderLeftWidth: j,
        borderRightWidth: j,
        borderTopWidth: j,
    ...
    !function (a, b, c) {
      ...
      function c(a, b) {
        if (b = b.trim().toLowerCase(), "0" == b && "px".search(a) >= 0) return { px: 0 };
        if (/^[^(]*$|^calc/.test(b)) {
          b = b.replace(/calc\(/g, "(");
          var c = {};
      ...
      var f = "px|em|ex|ch|rem|vw|vh|vmin|vmax|cm|mm|in|pt|pc", g = c.bind(null, new RegExp(f, "g")),
        h = c.bind(null, new RegExp(f + "|%", "g")), i = c.bind(null, /deg|rad|grad|turn/g);
        ...
        for (var c, d = /\s*(\w+)\(([^)]*)\)/g, e = [], f = 0; c = d.exec(b);) {
          ...
          for (var k = [], o = 0; o < j.length; o++) {
            ...
            if (p = q ? {
              ...
              }, N: a.parseNumber, T: a.parseLengthOrPercent, L: a.parseLength
            }[r.toUpperCase()](q) : { a: m, n: k[0], t: l }[r], void 0 === p) return;
            k.push(p)
          }
      ...
      function g(b, c) {
        ...
        return null == d[0] || null == e[0] ? [[!1], [!0], function (a) {
          ...
          var c = a.quat(d[0][3], e[0][3], b[5]), g = a.composeMatrix(b[0], b[1], b[2], c, b[4]),
            h = g.map(f).join(",");
          return h
        }])
      }
    ...
    if (void 0 === document.createElement("div").animate([]).oncancel) {
      ...
      var b = function (a, b, c) {
        this.target = a, this.currentTime = b, this.timelineTime = c, this.type = "cancel", this.bubbles = !1, this.cancelable = !1,
          this.currentTarget = a, this.defaultPrevented = !1, this.eventPhase = Event.AT_TARGET, this.timeStamp = Date.now()
...
(function (window, document) {
  ...
  function e(a) {
    ...
    this.a = { tags: [] };
    this.g = a;
    this.c = a.querySelectorAll(".codelab-card");
    for (var d = a = 0; d < this.c.length; d++) {
      var b = this.c[d];
      b.j = (b.dataset.title || "").trim().toLowerCase();
      b.h = f((b.dataset.category || "").split(","));
      b.tags = f((b.dataset.tags || "").split(","));
      b.f = new Date(b.dataset.updated);
      b.duration = parseInt(b.dataset.duration, 10);
      b.dataset.pin && (a += 1, b.b = a);
    }
  }
  ...
  e.prototype.filter = function (a) {
    this.a.cat = h(a.cat);
    this.a.text = h(a.text);
    this.a.tags = f(a.tags);
    this.a.kioskTags = f(a.kioskTags);
    g(this);
  };
  ...
  function g(a) {
    for (var d = Array.prototype.slice.call(a.c, 0), b = d.length; b--;) {
      var c = d[b];
      if (a.a.kioskTags && 0 < a.a.kioskTags.length && !l(a.a.kioskTags, c.tags)) c = !1; else {
        var n = !a.a.cat;
        if (a.a.cat) for (var k = 0; k < c.h.length; k++) {
          a.a.cat === c.h[k] && (n = !0);
        }
  ...
  function m(a, d) {
    switch (a.i) {
      case "duration":
        d.sort(function (a, c) {
          var b = p(a, c);
          return null !== b ? b : a.duration - c.duration;
        });
        break;
      case "recent":
        d.sort(function (a, c) {
          var b = p(a, c);
          return null !== b ? b : c.f < a.f ? -1 : c.f > a.f ? 1 : 0;
        });
        break;
      default:
        d.sort(function (a, c) {
          var b = p(a, c);
          return null !== b ? b : a.dataset.title < c.dataset.title ? -1 : a.dataset.title > c.dataset.title ? 1 : 0;
        });
    }
  }
